...
export default function AboutMeSection({ data }: AboutMeSectionProps) {
  ...
  return (
    <section id="about-me" className="py-16 md:py-24 bg-secondary/30 text-foreground print-break-inside-avoid">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
              <div>
                {summaryPoints.map((point, index) => (
                  <p key={index} className="text-lg text-foreground/90 mb-4 leading-relaxed print-text-black">
                    {point}
                  </p>
                ))}
              </div>
              <div>
                <div className="mb-6">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-foreground/80 print-text-black">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-foreground/80 print-text-black">{internship}</p>
                </div>
              </div>
            </div>
